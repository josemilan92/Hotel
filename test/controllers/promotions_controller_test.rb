...
class PromotionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create promotion" do
    assert_difference('Promotion.count') do
      post promotions_url, params: { promotion: { description: @promotion.description, name: @promotion.name, photo: @promotion.photo, price: @promotion.price } }
    end
  ...
  test "should update promotion" do
    patch promotion_url(@promotion), params: { promotion: { description: @promotion.description, name: @promotion.name, photo: @promotion.photo, price: @promotion.price } }
