...
class ComentariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post comentarios_url, params: { comentario: { cuerpo: @comentario.cuerpo, promotion_id: @comentario.promotion_id } }
    end
  ...
  test "should update comentario" do
    patch comentario_url(@comentario), params: { comentario: { cuerpo: @comentario.cuerpo, promotion_id: @comentario.promotion_id } }
