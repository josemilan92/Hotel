...
class EstadosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estado" do
    assert_difference('Estado.count') do
      post estados_url, params: { estado: { estados: @estado.estados, nombre: @estado.nombre } }
    end
  ...
  test "should update estado" do
    patch estado_url(@estado), params: { estado: { estados: @estado.estados, nombre: @estado.nombre } }
