...
class HotelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hotel" do
    assert_difference('Hotel.count') do
      post hotels_url, params: { hotel: { descripcion: @hotel.descripcion, nombre: @hotel.nombre, photo: @hotel.photo } }
    end
  ...
  test "should update hotel" do
    patch hotel_url(@hotel), params: { hotel: { descripcion: @hotel.descripcion, nombre: @hotel.nombre, photo: @hotel.photo } }
