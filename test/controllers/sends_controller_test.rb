...
class SendsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create send" do
    assert_difference('Send.count') do
      post sends_url, params: { send: {fechaPri: @send.fechaPri, fechaUlt: @send.fechaUlt, lugar: @send.lugar, pago: @send.promocion } }
    end
  ...
  test "should update send" do
    patch send_url(@send), params: { send: {fechaPri: @send.fechaPri, fechaUlt: @send.fechaUlt, lugar: @send.lugar, pago: @send.promocion } }
